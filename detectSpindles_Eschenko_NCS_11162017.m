function detectSpindles_Eschenko_NCS_11162017
...
duration(duration<0.3 | duration>2) = NaN;
...
matFileName = strcat(filename,'_SpindlesKS.mat');

% Determine if .MAT file already exists:
matFile = fullfile(CSCFilePath, matFileName);
if exist(matFile, 'file') == 2
    save(matFile, 'EschenkoSpindle', 'TimeStamps', 'scoredFile', 'CSCFilename','threshMultiplierRMS', '-append');
else
    save(matFile, 'EschenkoSpindle', 'TimeStamps', 'scoredFile', 'CSCFilename','threshMultiplierRMS');
end
end