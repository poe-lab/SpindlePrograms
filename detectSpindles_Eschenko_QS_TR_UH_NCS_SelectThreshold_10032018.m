function detectSpindles_Eschenko_QS_TR_UH_NCS_SelectThreshold_10032018
...
info.stdDevNremRMS = std(rmsSignal(sleepsamp==2 | sleepsamp==6| sleepsamp==5));
...
aboveThreshold = rmsSignal > threshold & (sleepsamp==2 | sleepsamp==6 | sleepsamp==5);
clear rmsSignal
